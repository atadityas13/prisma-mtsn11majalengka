...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="cetak_daftar_peserta.php" target="_blank" class="btn btn-outline-info">
            <i class="bx bx-user-pin me-1"></i> Cetak Semua Daftar Peserta
        </a>
    ...
    <div class="col-sm-4">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body py-3">
                ...
                <div class="fw-bold fs-4 <?= $count_belum > 0 ? 'text-danger' : 'text-muted' ?>"><?= $count_belum ?>
                </div>
            </div>
        </div>
    </div>
...
<?php else: ?>
    ...
    <?php if ($count_belum > 0): ?>
        <div class="alert alert-warning d-flex align-items-center mb-4 py-2" style="font-size:.875rem;">
            ...
            <span>Ada <strong><?= $count_belum ?> penguji</strong> yang belum memiliki jadwal. Klik tombol <strong>Atur</strong>
                pada baris yang berstatus <em>Belum</em> untuk menetapkan tanggal, jam, dan ruangan.</span>
        </div>
    <?php endif; ?>
                    ...
                    <tbody>
                        <?php foreach ($plotings as $p): ?>
                            <tr>
                                ...
                                <td><?= $p['ruangan'] ? htmlspecialchars($p['ruangan']) : '<span class="text-muted fst-italic">—</span>' ?>
                                </td>
                                <td>
                                    <?php if ($p['tanggal']): ?>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <?php if ($p['tanggal']): ?>
                                            <a href="cetak_daftar_peserta.php?ploting_id=<?= $p['ploting_id'] ?>" target="_blank"
                                                class="btn btn-sm btn-outline-info" title="Cetak Daftar Peserta">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger hapus-btn"
                                                data-ploting-id="<?= $p['ploting_id'] ?>"
                                                data-guru="<?= htmlspecialchars($p['nama_guru']) ?>" title="Hapus Jadwal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ruangan" id="modal_ruangan" class="form-control"
                                placeholder="Contoh: Lab IPA, Kelas IX-A" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Keterangan (Opsional)</label>
                            <textarea name="keterangan" id="modal_keterangan" class="form-control" rows="2"
                                placeholder="Misal: Bawa alat praktik sendiri"></textarea>
                        </div>
                    </div>
